...
function App() {
    return ( <
        ...
        element = { < Database / > }
        />{" "} <
        Route path = "/database/:contactId"
        element = { < ContactDetails / > }
        /> <
        Route path = "/emails"
        element = { < EmailSender / > }
        />{" "} <
        Route path = "/emails/:emailId/edit"
        element = { < CreateEmail / > }
        />{" "} <
        Route path = "/emails/:emailId/send"
        element = { < SentEmail / > }
        />{" "} <
        Route path = "/emails/:emailId/view"
        ...
        />{" "} <
        Route path = "/certificate/:certificateId/customize"
